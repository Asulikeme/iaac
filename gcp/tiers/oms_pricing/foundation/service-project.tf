...
module "omsp_project" {
  ...
  random_suffix         = var.gcp_omsp_project_object.gcp_random_suffix
  folder_id             = var.parent_folder
  labels                = var.gcp_omsp_project_object.gcp_labels
  enforce_cis_standards = var.gcp_omsp_project_object.gcp_enforce_cis_standards
...
resource "google_compute_shared_vpc_service_project" "shared_vpc" {
  ...
  service_project = trimprefix(module.omsp_project.project_id, "projects/")
}
