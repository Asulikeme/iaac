variable "rules" {
  ...
  default = {
    ...
    #  Mongodb Atlas
    mongodb-1024-tcp = [1024, 1024, "tcp", "Mongodb port 1"]
    mongodb-1025-tcp = [1025, 1025, "tcp", "Mongodb port 2"]
    mongodb-1026-tcp = [1026, 1026, "tcp", "Mongodb port 3"]
    msk-11001-tcp    = [11001, 11001, "tcp", "Msk monitoring port 1"]
    msk-11002-tcp    = [11002, 11002, "tcp", "Msk monitoring port 2"]
...
variable "auto_groups" {
  ...
  default = {
    ...
    mongodbatlas = {
      ingress_rules     = ["mongodb-1024-tcp", "mongodb-1025-tcp", "mongodb-1026-tcp"]
      ingress_with_self = ["all-all"]
      egress_rules      = ["all-all"]
    }
    msk = {
      ingress_rules     = ["msk-11001-tcp", "msk-11002-tcp"]
      ingress_with_self = ["all-all"]
      egress_rules      = ["all-all"]
    }
  }
